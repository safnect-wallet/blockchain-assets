import { eosWallet } from '@src/wallets';
import { networkType } from '@src/constants';

const clientTestnet = "https://eos.api.eosnation.io";
const clientMainnet = "https://eos.api.eosnation.io";
...
async function sendTx(network, transaction, privateKey) {
	...
	const tx = await eosWallet.signTransaction(param);
